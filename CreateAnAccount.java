...
public class CreateAnAccount extends TestBase {
	...
	public void setUp() throws Exception {
		...
		tcData = TestUtil.readDataFromTC("CreateAnAccount");
	}
	...
	public void createAnAccount() throws Exception {
		...
		WebElement signIn = driver.findElement(By.xpath("//a[@routerlink='/register']"));
		signIn.click();
		...
		email.sendKeys(tcData.get("Label2"));
		Thread.sleep(2000);	
		
		WebElement password = driver.findElement(By.xpath("//input[@formcontrolname='password']"));
		password.sendKeys(tcData.get("Label3"));
		Thread.sleep(2000);	
		
		WebElement confirmPassword = driver.findElement(By.xpath("//input[@formcontrolname='confirmPassword']"));
		confirmPassword.sendKeys(tcData.get("Label4"));
		Thread.sleep(2000);	
