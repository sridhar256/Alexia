...
public class ToggleSlidebar extends TestBase {
	...
	@Test(priority=1)
	public void verifyDarkColorToogleTheme() throws Exception {
		...
		logger = extent.createTest("DarkColorTheme_TC_1");
		logger.log(Status.INFO,MarkupHelper.createLabel("TestCase(DarkColorTheme_TC_1): Validate Email textbox in Signin page.",ExtentColor.BLUE));	
		...
		logger = extent.createTest("DarkColorTheme_TC_2");
		logger.log(Status.INFO,MarkupHelper.createLabel("TestCase(DarkColorTheme_TC_2): Validate Password textbox in Signin page.",ExtentColor.BLUE));	
		...
		logger = extent.createTest("DarkColorTheme_TC_3");
		logger.log(Status.INFO,MarkupHelper.createLabel("TestCase(DarkColorTheme_TC_3): Validate 'Sign in' button in 'Sign in' page.",ExtentColor.BLUE));	
		...
		WebElement toggleSlidebar = driver.findElement(By.xpath("//i[@title='Toggle Sidebar']"));
		toggleSlidebar.click();
		Thread.sleep(3000);	
	...
	public void verifyLightColorToogleTheme() throws Exception {
		...
		logger = extent.createTest("LightColorTheme_TC_1");
		logger.log(Status.INFO,MarkupHelper.createLabel("TestCase(LightColorTheme_TC_1): Validate Email textbox in Signin page.",ExtentColor.BLUE));	
		logger.log(Status.PASS,MarkupHelper.createLabel("User is able to input 'jastisatyanarayana256@gmail.com' in email field in Signin page.",ExtentColor.GREEN));  

		WebElement password = driver.findElement(By.xpath("//input[@formcontrolname='password']"));
		password.sendKeys(tcData.get("Label2"));
		
		logger = extent.createTest("LightColorTheme_TC_2");
		logger.log(Status.INFO,MarkupHelper.createLabel("TestCase(LightColorTheme_TC_2): Validate Password textbox in Signin page.",ExtentColor.BLUE));	
		logger.log(Status.PASS,MarkupHelper.createLabel("User is able to input 'Teamwork@1' in password field in Signin page.",ExtentColor.GREEN));  

		WebElement signIn = driver.findElement(By.xpath("//button[@type='submit']"));
		signIn.click();
		
		logger = extent.createTest("LightColorTheme_TC_3");
		logger.log(Status.INFO,MarkupHelper.createLabel("TestCase(LightColorTheme_TC_3): Validate 'Sign in' button in 'Sign in' page.",ExtentColor.BLUE));	
		logger.log(Status.PASS,MarkupHelper.createLabel("User is able to click 'Sign in' button in 'Sign in' page.",ExtentColor.GREEN));  
		...
		WebElement toggleSlidebarAgain = driver.findElement(By.xpath("//i[@title='Toggle Sidebar']"));
		toggleSlidebarAgain.click();
		Thread.sleep(3000);	
