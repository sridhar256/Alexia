...
public class ToggleTheme extends TestBase {
	...
	public void verifyDarkColorToogleTheme() throws Exception {
		...
		WebElement toggleThemeLight = driver.findElement(By.xpath("//a[@title='Toggle Theme']/span"));
		toggleThemeLight.click();
		Thread.sleep(3000);	
	...
	public void verifyLightColorToogleTheme() throws Exception {
		...
		WebElement toggleThemeDark = driver.findElement(By.xpath("//a[@title='Toggle Theme']/span"));
